...
struct MapDirectionModel: Codable {
...
struct GeocodedWaypoint: Codable {
    var geocoderStatus, placeID: String?
    var types: [String]?
...
struct Route: Codable {
    ...
    var summary: String?
    var warnings, waypointOrder: [JSONAny]?
...
struct Bounds: Codable {
    var northeast, southwest: Northeast?
}
...
struct Leg: Codable {
    var arrivalTime, departureTime: Time?
    ...
    var steps: [Step]?
    var trafficSpeedEntry, viaWaypoint: [JSONAny]?
